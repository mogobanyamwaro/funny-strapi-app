...
export interface ApiDadiJokeDadiJoke extends Struct.CollectionTypeSchema {
  collectionName: 'dadi_jokes';
  info: {
    description: '';
    displayName: 'dadi-joke';
    pluralName: 'dadi-jokes';
    singularName: 'dadi-joke';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMemeMeme extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::meme.meme'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    topcaption: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dadi-joke.dadi-joke': ApiDadiJokeDadiJoke;
